...
namespace Snowball.Installation
{
    public class ReleaseInfo
    {
        ...
        public IDictionary<SemVersion, IList<Dependency>> ReleaseVersions { get; }
        ...
        public ReleaseInfo(string name, string description, IList<string> authors, IList<string> tags,
            IDictionary<SemVersion, IList<Dependency>> versions, PackageType packageType, string publicKey)
        {
        ...
        public ReleaseInfo(PackageInfo packageInfo)
        {
            ...
            this.ReleaseVersions = new Dictionary<SemVersion, IList<Dependency>>
            {
