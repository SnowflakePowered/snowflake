...
namespace Snowflake.Packaging.Snowball
{
    ...
    public class PackageInfo
    {
        ...
        public PackageInfo(string name, string description, IList<string> authors, string version, IList<string> dependencies, PackageType packageType)
        {
        ...
        public PackageInfo(string name, string description, IList<string> authors, string version,
            ...
            : this(name, description, authors, version, dependencies, (PackageType)Enum.Parse(typeof(PackageType), packageType, true))
        {
