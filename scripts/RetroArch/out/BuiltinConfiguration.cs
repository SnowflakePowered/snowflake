...
namespace Snowflake.Plugin.EmulatorAdapter.RetroArch.Configuration.Internal
{
 ...
 public interface BuiltinConfiguration : IConfigurationSection<BuiltinConfiguration>
    {
       [ConfigurationOption("builtin_imageviewer_enable",true, DisplayName = "Builtin Imageviewer Enable", Private = true)]
       bool BuiltinImageviewerEnable { get; set; }
       [ConfigurationOption("builtin_mediaplayer_enable",true, DisplayName = "Builtin Mediaplayer Enable", Private = true)]
