...
namespace Snowflake.Language.Analyzers.Configuration
{
    ...
    public sealed class GenericArgumentRequiresConfigurationCollectionAnalyzer
        : AbstractGenericTypeRequiresAttributeAnalyzer
    {
        ...
        private static readonly DiagnosticDescriptor _Rule =
            new DiagnosticDescriptor(
                ...
                description: "The specified generic argument must be an interface with the [ConfigurationCollection] attribute.");
        ...
        protected override (INamedTypeSymbol marker, INamedTypeSymbol target) GetAttributes(Compilation compilation)
        {
            ...
            return (types.GenericTypeAcceptsConfigurationCollectionAttribute, types.ConfigurationCollectionAttribute);
        }
    }
}
