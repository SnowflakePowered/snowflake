...
{
    internal class InputMappingConverter : JsonCreationConverter<DictionaryInputMapping>
    {
        /// <inheritdoc/>
        protected override DictionaryInputMapping Create(Type objectType, JObject jObject)
        {
