...
{
    public sealed class CopyDirectoryTask : InstallTaskAwaitableEnumerable<IFile?>
    {
        ...
        public CopyDirectoryTask(DirectoryInfo source, IDirectory destinationDirectory)
        {
            this.Source =  source;
