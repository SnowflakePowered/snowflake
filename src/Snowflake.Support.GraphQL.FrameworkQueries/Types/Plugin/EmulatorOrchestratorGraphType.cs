...
{
    public class EmulatorOrchestratorGraphType : ObjectGraphType<IEmulatorOrchestrator>
    {
        public EmulatorOrchestratorGraphType()
        {
            Name = "EmulatorOrchestrator";
            Description = "An emulator orchestrator plugin.";
            Field(p => p.Author).Description("The author of the plugin.");
            Field(p => p.Description).Description("The description of the plugin.");
            Field(p => p.Name).Description("The name of the emulator orchestrator.");
