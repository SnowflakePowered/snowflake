        ...
        : ObjectType<FileInfo>
    {
        protected override void Configure(IObjectTypeDescriptor<FileInfo> descriptor)
        {
            ...
            descriptor.Field("isHidden")
                ...
                .Resolve(context => context.Parent<FileInfo>().Attributes.HasFlag(FileAttributes.Hidden));
        }
    }
}
