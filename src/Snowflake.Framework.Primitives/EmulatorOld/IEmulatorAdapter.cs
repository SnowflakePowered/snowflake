...
namespace Snowflake.EmulatorOld
{
    ...
    public interface IEmulatorAdapter : IPlugin
    {
        ...
        /// <summary>
        /// Gets a list of emulator capabiities strings under the capabilities metadata key.
        ...
        /// <summary>
        /// Gets a list of BIOS files this emulator supports optionally, listed under the optional metata key
        /// optionalbios.
        /// </summary>
        ...
        /// <summary>
        /// Gets the save manager for this emulator adapter, used to manage separate save files for
        /// individual games.
        /// </summary>
        ISaveManager SaveManager { get; }

        /// <summary>
        /// Gets the BIOS Manager for this emulator adapter, used to managed installed BIOS files.
        /// </summary>
