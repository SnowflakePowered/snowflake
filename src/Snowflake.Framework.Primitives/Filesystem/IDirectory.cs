...
namespace Snowflake.Filesystem
{
          ...
          IEnumerableDirectoryBase<IDeletableDirectory, IFile>
    {
        ...
        /// <see cref="IReadOnlyFile.UnsafeGetPath"/> will return the path of the linked file.
        ...
        /// <param name="source">The <see cref="FileInfo"/></param>
        /// <returns>The <see cref="IFile"/> that describes the file in the current <see cref="IDirectory"/>.</returns>
        IFile LinkFrom(FileInfo source, string targetName);
        ...
        /// The new link will inherit the GUID of the previously existing file.</param>
        /// <returns>The <see cref="IFile"/> that describes the file in the current <see cref="IDirectory"/>.</returns>
        IFile LinkFrom(FileInfo source, string targetName, bool overwrite);
        ...
        /// <param name="source">The <see cref="FileInfo"/></param>
        /// <returns>The <see cref="IFile"/> that describes the file in the current <see cref="IDirectory"/>.</returns>
        IDeletableDirectory LinkFrom(DirectoryInfo source);
        ...
        /// The new link will inherit the GUID of the previously existing file.</param>
        /// <returns>The <see cref="IFile"/> that describes the file in the current <see cref="IDirectory"/>.</returns>
        IDeletableDirectory LinkFrom(DirectoryInfo source, bool overwrite);
        ...
        /// <param name="source">The <see cref="FileInfo"/></param>
        /// <returns>The <see cref="IFile"/> that describes the file in the current <see cref="IDirectory"/>.</returns>
        IDeletableDirectory LinkFrom(DirectoryInfo source, string targetName);
        ...
        /// The new link will inherit the GUID of the previously existing file.</param>
        /// <returns>The <see cref="IFile"/> that describes the file in the current <see cref="IDirectory"/>.</returns>
        IDeletableDirectory LinkFrom(DirectoryInfo source, string targetName, bool overwrite);
    }
}
