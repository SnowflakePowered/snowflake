...
namespace Snowflake.Filesystem
{
    ...
    public interface IDirectory
    {
        ...
        IDeletableDirectory OpenDirectory(string name);
        ...
        /// a <see cref="IDeletableDirectory"/>.
        /// Do not use this method to copy from a managed <see cref="IDeletableDirectory"/>.
        ...
        /// a <see cref="IDeletableDirectory"/>.
        /// Do not use this method to copy from a managed <see cref="IDeletableDirectory"/>.
        /// Instead, use <see cref="IDeletableDirectory.CopyFrom(IReadOnlyFile)"/>.
        /// </summary>
        /// <exception cref="IOException">If a file with the same name exists in the target destination.</exception>
        /// <exception cref="FileNotFoundException">If the source file can not be found.</exception>
        /// <param name="source">The <see cref="FileInfo"/></param>
        ...
        /// <summary>
        /// Copies a file from a <see cref="IFile"/> from another <see cref="IDeletableDirectory"/>, updating the
        ...
        IEnumerable<IDeletableDirectory> EnumerateDirectories();
        ...
        /// a <see cref="IDeletableDirectory"/>. Links are akin to shortcuts more than symbolic links,
        ...
        /// <see cref="IDeletableDirectory"/> methods like <see cref="CopyFrom(IReadOnlyFile)"/> and <see cref="MoveFrom(IFile)"/> work as 
        /// expected.
        /// </para>
        /// <para>
        ...
        /// <exception cref="FileNotFoundException">If the source file can not be found.</exception>
        /// <param name="source">The <see cref="FileInfo"/></param>
        /// <param name="overwrite">Overwrite the file if it already exists in this <see cref="IDeletableDirectory"/>.
