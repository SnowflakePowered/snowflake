...
namespace Snowflake.Support.Orchestration.Overlay.Runtime.Windows.Hooks.Direct3D9
{
    public enum Direct3DDevice9Ordinals
    {
        QueryInterface = 0,
        AddRef = 1,
        Release = 2,
    ...
    public enum Direct3DDevice9ExOrdinals
    {
