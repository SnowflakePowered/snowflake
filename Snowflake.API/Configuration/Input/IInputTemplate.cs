...
namespace Snowflake.Configuration.Input
{
    ...
    {
        /// <summary>
        /// The template in which the values are stored for this input configuration
        /// </summary>
        T Template { get; }
    }
    ...
    public interface IInputTemplate : IConfigurationSection
    {
        ...
        /// <summary>
        /// The mapped controller elements of the input configuration.
        ...
        /// <summary>
        /// The options representing the fields in which the options are serialized in configuration,
