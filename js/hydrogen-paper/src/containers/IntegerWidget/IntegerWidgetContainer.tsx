...
const IntegerWidgetContainer: React.SFC<SnowflakeProps & IntegerWidgetProps> = ({snowflake, option, configKey, handleUpdate}) => {
...
export default withSnowflake(IntegerWidgetContainer)
